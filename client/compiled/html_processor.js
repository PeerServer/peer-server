...
(function() {
  ...
  window.HTMLProcessor = (function() {
    ...
    function HTMLProcessor(sendEvent, setDocumentElementInnerHTML, getIDFn) {
      ...
      this.processImageAsHTML = function(html, completionCallback) {
        return HTMLProcessor.prototype.processImageAsHTML.apply(_this, arguments);
      };
      this.processTitle = function() {
        return HTMLProcessor.prototype.processTitle.apply(_this, arguments);
      };
