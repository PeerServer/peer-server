  ...
  window.ClientBrowser = (function() {
    ...
    function ClientBrowser(documentElement) {
      ...
      this.executeScriptsCallback = function(scriptMapping) {
        return ClientBrowser.prototype.executeScriptsCallback.apply(_this, arguments);
      };
      this.setDocumentElementInnerHTML = function(data, optionalInfo) {
        return ClientBrowser.prototype.setDocumentElementInnerHTML.apply(_this, arguments);
      };
      this.setUpReceiveEventCallbacks = function(startPage) {
        return ClientBrowser.prototype.setUpReceiveEventCallbacks.apply(_this, arguments);
      };
      this.channelOnMessage = function(message) {
        return ClientBrowser.prototype.channelOnMessage.apply(_this, arguments);
      };
      this.sendEvent = function(eventName, data) {
        return ClientBrowser.prototype.sendEvent.apply(_this, arguments);
      };
      this.parseUrl = function(locationObj) {
        return ClientBrowser.prototype.parseUrl.apply(_this, arguments);
      };
      this.getID = function() {
        return ClientBrowser.prototype.getID.apply(_this, arguments);
      };
