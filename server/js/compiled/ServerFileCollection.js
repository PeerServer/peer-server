...
(function() {
  ...
  window.ServerFileCollection = (function(_super) {
    ...
    function ServerFileCollection() {
      ...
      this.hasProductionFile = function(filename) {
        return ServerFileCollection.prototype.hasProductionFile.apply(_this, arguments);
      };
      ...
      this.filenameAndExtension = function(filename) {
        return ServerFileCollection.prototype.filenameAndExtension.apply(_this, arguments);
      };
      this.isFilenameInUse = function(filename) {
        return ServerFileCollection.prototype.isFilenameInUse.apply(_this, arguments);
      };
      this.onServerFileAdded = function(serverFile) {
        return ServerFileCollection.prototype.onServerFileAdded.apply(_this, arguments);
      };
