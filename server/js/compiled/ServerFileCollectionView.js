  ...
  window.ServerFileCollectionView = (function(_super) {
    ...
    function ServerFileCollectionView() {
      ...
      this.eventKeyDown = function(event) {
        return ServerFileCollectionView.prototype.eventKeyDown.apply(_this, arguments);
      };
      this.eventDeleteFileConfirmed = function(event) {
        return ServerFileCollectionView.prototype.eventDeleteFileConfirmed.apply(_this, arguments);
      };
      this.eventDeleteFile = function(event) {
        return ServerFileCollectionView.prototype.eventDeleteFile.apply(_this, arguments);
      };
      this.eventRenameFile = function(event) {
        return ServerFileCollectionView.prototype.eventRenameFile.apply(_this, arguments);
      };
